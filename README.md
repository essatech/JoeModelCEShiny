...
This is the location of the Shiny UI associated with the [`JoeModelCE`](github.com/essatech/JoeModelCE) package. `JoeModelCE` is a collection of functions to support the application of the <a href="https://waves-vagues.dfo-mpo.gc.ca/Library/40871344.pdf" target="Alberta Environmental Parks Cumulative Effects Assessment Joe Model (AEP CEM; DFO 2019)">PDF.</a>, coupled with a flexible population modelling framework.
